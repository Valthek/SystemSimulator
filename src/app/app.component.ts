...
@Component({
  ...
  styleUrls: ['./../styling/main.scss'] 
})
export class AppComponent implements AfterViewInit {
  @ViewChild('simulatorCanvas') myCanvas: ElementRef;

  planets: planet[];
  availableSystems : string[] = [/*"antara",*/ "astraea", "concilium", "descoberta", "epsilon-eridani", 
                                "fareedat", "helios", "mitra", "paradiso", "sol", "tencendur", "yu-jing"];
  cObjects: cObject[];
